...
static inline void jsimd_h2v1_fancy_upsample_neon(int max_v_samp_factor,
...
static inline void jsimd_h2v2_fancy_upsample_neon(int max_v_samp_factor,
                                    JDIMENSION downsampled_width,
                                    JSAMPARRAY input_data,
                                    JSAMPARRAY *output_data_ptr)
{
...
static inline void jsimd_h2v1_upsample_neon(int max_v_samp_factor,
...
static inline void jsimd_h2v2_upsample_neon(int max_v_samp_factor,
                              JDIMENSION output_width,
                              JSAMPARRAY input_data,
                              JSAMPARRAY *output_data_ptr)
{
