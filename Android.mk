...
libjpeg_turbo_common_cflags += -DJDCT_DEFAULT=JDCT_IFAST
...
LOCAL_LDFLAGS := -version-info 1:0:1 -no-undefined

LOCAL_SRC_FILES += turbojpeg.c transupp.c jdatadst-tj.c jdatasrc-tj.c
